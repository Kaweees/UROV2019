...
class Robot(Node):
    ...
    def get_new_tasks(self) -> SomeTasks:
        ...
        """
        sched_list = [] #this is not getting filled up in the debug for some reason(ignore until you knwo what this means) 
        print("in robot->get_new_tasks ")
        if settings.USE_CONTROLS_SOCKETS:
